    ...
    <div className="rounded-xl border border-zinc-200 p-6 transition hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-900">
      ...
      <Link href={href} className="block">
        <div className="flex cursor-pointer flex-col gap-1">
          ...
          {subtitle && (
            <p className="ml-[44px] text-sm text-zinc-500 dark:text-zinc-400">{subtitle}</p>
          )}
        </div>
      </Link>
      ...
      <div className="mt-8 flex justify-center">
        <button
          ...
          className="rounded-md bg-zinc-200 px-3 py-1 text-sm text-zinc-700 transition hover:bg-zinc-300 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-600"
        >
